...
@section ('content')
    ...
    <?php
    $all_category_by_product=DB::table('tbl_product')
        ->get(); ?>
 <?php   foreach($all_category_by_product as $v_category_by_product) { ?>
    <div class="col-sm-4">
        <div class="product-image-wrapper">
            <div class="single-products">
                <div class="productinfo text-center">
                    <img src="{{url($v_category_by_product->product_image)}}" style="height: 210px;" alt="" />
