            ...
            <div class="box-content">
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tr>
                        ...
                        <td class="center">
                            @if($v_category->publication_status==1)
                                <a class="btn btn-danger" href="{{url('/unactive-category/'.$v_category->category_id)}}">
                                     <i class="halflings-icon white thumbs-down"></i>
                                 </a>
                            @else
                                <a class="btn btn-success" href="{{url('/active-category/'.$v_category->category_id)}}">
                            ...
                            <a class="btn btn-danger" href="{{url('/delete-category/'.$v_category->category_id)}}">
