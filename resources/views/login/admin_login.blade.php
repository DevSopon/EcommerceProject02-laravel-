                ...
                <form class="form-horizontal" action="{{url('/admin_dashboard')}}" method="post">
                    ...
                    <fieldset>
                        ...
                        <div class="input-prepend" title="Username">
                            ...
                            <input class="input-large span10" name="admin_email" type="text" placeholder="Enter Your Email "/>
                        ...
                        <div class="input-prepend" title="Password">
                            ...
                            <input class="input-large span10" name="admin_password" type="password" placeholder="Enter Your Password"/>
