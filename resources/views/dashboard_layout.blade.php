        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li><a href="{{url('/all-category')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All categories</span></a></li>
                    <li><a href="{{url('/add-category')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a></li>

                    <li><a href="{{url('/all-brand')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Brand </span></a></li>
                    <li><a href="{{url('/add-brand')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Brands</span></a></li>
                    <li>
                        ...
                        <ul>
                            <li><a class="submenu" href="{{url('/add-product')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add new product</span></a></li>
                            <li><a class="submenu" href="{{url('/all-product')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> View All product</span></a></li>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a class="submenu" href="{{url('/add-slider')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add new Slider</span></a></li>
                            <li><a class="submenu" href="{{url('/all-slider')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> View All Slider</span></a></li>
