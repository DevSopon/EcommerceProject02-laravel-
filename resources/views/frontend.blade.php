...
<style type="text/css">
                        ...
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="{{url('/login-check')}}"> Checkout</a></li>
                                    <?php } ?>
                                <li><a href="{{url('/show_cart_details')}}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
                            ...
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        ...
                                        <li><a href="{{url('/login-check')}}">Checkout</a></li>
                                        <li><a href="{{url('/show_cart_details')}}">Cart</a></li>
    ...
    <?php
    $all_published_slider=DB::table('slider_tbls')
                    ...
                    <div class="left-sidebar">
                        ...
                        <div class="brands-name">
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="{{url('/product-by-manufacture/'.$v_brand->manufacture_id)}}"> <span class="pull-right">(50)</span>{{$v_brand->manufacture_name}}</a></li>
                            </ul>
                        </div>
                        <?php }   ?>
                    </div>
